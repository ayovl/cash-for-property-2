      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-8 max-w-6xl mx-auto leading-tight">
            We Are A Team Of <span className="text-gray-400">Trusted Experts</span> Creating{' '}
            <span className="text-black">Fast, Reliable,</span> And <span className="text-black">Hassle-Free</span>{' '}
            <span className="text-gray-400">Property Solutions.</span> From <span className="text-gray-400">Initial Contact To Final Settlement,</span>{' '}
            We Work With <span className="text-black">Purpose And Precision</span>{' '}
            <span className="text-gray-400">To Bring</span> <span className="text-black">Your Cash Offer To Life</span>
          </h2>
          
          <div className="flex justify-center space-x-4 mt-12">
            <div className="w-32 h-20 bg-gray-200 rounded-2xl overflow-hidden">
              <img 
